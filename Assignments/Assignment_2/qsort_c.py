...
# version 3 - pivot = median of three (first, middle and last element)
num_of_comparisons = 0  

def swap_pivot(array, low, high):
    mid = low + (high-1-low) // 2
    elements = [array[low], array[mid], array[high-1]]
    indexes = {array[low]:low, array[mid]:mid, array[high-1]:high-1}
    elements.sort()
    pivot = indexes[elements[1]]
